                ...
                <cfoutput>
                    <cfloop array="#contacts#" index="contacts">
                        ...
                        <tr>
                            ...
                            <td class="not-print"><a class="edit editPop #element#" data-userid="#encryptedUserId#" >Edit</a></td>
                            <td class="not-print"><a class="edit deletePop #element#"  data-userid="#encryptedUserId#">Delete</a></td>
                            <td class="not-print"><a class="edit viewPop" data-userid="#encryptedUserId#">View</a></td>
                        </tr>
                    </cfloop>
                </cfoutput>
            <cfcatch>
